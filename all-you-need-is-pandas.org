...
#+ATTR_REVEAL: :frag (t)
   1. Acquire samples of users' handwriting as SVG pages
...
*** /Example SVG Page/
    :PROPERTIES:
    :reveal_background: img/story1-example-excerpt.svg
    :reveal_background_position: 60% 40%
    :reveal_data_state: svgexampleshown
    :CUSTOM_ID: svg-example
    :END:

 \\

 #+ATTR_REVEAL: :frag fade-down
 [[./img/story1-example-detail.svg]]
